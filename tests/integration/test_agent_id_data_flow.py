...
class TestAgentIdDataFlow:
    """Verify agent_id flows correctly through spawn → task → events → stats"""

    def test_full_spawn_task_events_flow(self, tmp_path, monkeypatch):
    ...
    def test_invalid_agent_id_rejected_in_emit(self, tmp_path, monkeypatch):
    ...
    def test_emit_with_valid_agent_id_from_ensure_agent(self, tmp_path, monkeypatch):
    ...
    def test_agent_archival_preserves_invariant(self, tmp_path, monkeypatch):
    ...
    def test_get_agent_name_none_handling(self, tmp_path, monkeypatch):
    ...
    def test_task_with_channel_preserves_agent_id(self, tmp_path, monkeypatch):
    ...
    def test_multiple_agents_distinct_ids(self, tmp_path, monkeypatch):
    ...
    def test_task_list_all_have_agent_id(self, tmp_path, monkeypatch):
