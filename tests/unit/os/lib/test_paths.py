...
def test_canon_path_from_config(mocker):
    ...
    mocker.patch("space.os.lib.paths.space_root", return_value=mock_space_root)
    mocker.patch("space.os.config.load_config", return_value={"canon_path": "my_canon_dir"})
...
def test_canon_path_default(mocker):
    ...
    mocker.patch("space.os.lib.paths.space_root", return_value=mock_space_root)
    mocker.patch("space.os.config.load_config", return_value={})
