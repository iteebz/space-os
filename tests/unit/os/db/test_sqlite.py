...
def clean_registry():
    ...
    original_registry = sqlite._registry.copy()
    original_migrations = sqlite._migrations.copy()
    sqlite._registry.clear()
    sqlite._migrations.clear()
    yield
    sqlite._registry.clear()
    sqlite._migrations.clear()
    sqlite._registry.update(original_registry)
    sqlite._migrations.update(original_migrations)
