...
from space.bridge.coordination import channels as coordination_channels
...
def test_recv_does_not_return_messages_from_archived_channel(setup_channel):
    ...
    messages, unread_count, context, participants = coordination_messages.recv_updates(channel_id, identity)
