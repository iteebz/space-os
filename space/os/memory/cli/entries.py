...
def _list_entries(
    id: str, ctx, show_all: bool = False, raw_output: bool = False, topic: str | None = None
):
    try:
        entries = api.list_entries(id, topic=topic, show_all=show_all)  # explicit for clarity
