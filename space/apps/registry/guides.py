...
def get_guide_from_registry(guide_hash: str) -> str | None:
    ...
    constitution = registry_api.get_constitution_by_hash(guide_hash)
...
def load_guide_content(guide_name: str, guide_path: Path | None = None, guide_hash: str | None = None) -> str:
    ...
    if guide_hash:
        ...
        if content:
            _track_guide_loaded_event(guide_name, guide_hash, "registry")
            return content
...
def track_guide_in_registry(guide_hash: str, guide_content: str, guide_name: str):
