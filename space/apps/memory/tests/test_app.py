...
class TestMemoryRepo:
    def test_add_and_get_all(self, memory_repo: MemoryRepo):
        ...
        with patch('space.apps.memory.repo.uuid7', return_value="test-uuid-1"):
